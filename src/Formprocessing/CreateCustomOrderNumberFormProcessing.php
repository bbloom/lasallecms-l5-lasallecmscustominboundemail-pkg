...
namespace Lasallecms\Lasallecmscustominboundemail\Formprocessing;
 ...
 */
class CreateCustomOrderNumberFormProcessing extends BaseFormProcessing
{
    /*
     ...
     * @var string
     */
    protected $namespaceClassnameModel = "Lasallecms\Lasallecmscustominboundemail\Models\CustomOrderNumber";
